class CourseCatalog:
    ...
    USU_COURSES = {
        ...
        'cs5110': { 'course_number': 'cs5110', 'skills': ['literally nothing tbh', 'Multi-Agent Systems', 'Game Theory'] },
        ...
        'cs5460': { 'course_number': 'cs5460', 'skills': ['Computer Secuirty', 'Cyber Security', 'Encription', 'Hashing', 'Authentication'] },
